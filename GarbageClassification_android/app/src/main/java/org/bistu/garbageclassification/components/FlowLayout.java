...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        //计算出所有的childView的宽和高，调用后，它所有的childView的宽和高的值就被确定，也即getMeasuredWidth/Height（）有值了,否则为0。
        ...
        //AT_MOS 模式：对应wrap-content（需要手动计算大小，否则相当于match_parent）
    ...
    /**
     * 对其所有的子childView进行定位摆放。通过遍历子view，获取子view的宽高，再LayoutParams来获取边距，
     * 调用每个子view的layout()方法，填入与父view的上下左右边距，就设置了每个子view的位置和大小
     */
    @Override
